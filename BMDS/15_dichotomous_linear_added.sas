...
%macro boundBMD(BMR, CL,DATAIN, DATAOUT, ESTIMATES);
   ...
   proc nlmixed data=&DATAIN maxiter=1000;
      ...
      predict p out=prediction_linear;
   run;
   ...
   data prediction_linear2;
	  set prediction_linear;
   ...
   proc summary data=prediction_linear2 nway;
	  var sq_residual;
	  output out=prediction_linear3 (drop=_type_ _freq_) sum()= n=dosegroups;
   run;

   data prediction_linear3;
	  set prediction_linear3;
	  file print;
   ...
   *set up the initial parameters for the new likelihood;
   ...
   data plot_linear;
	  set prediction_linear2 plot_model plot_bmd plot_BMDL plot_BMR;
	  label dose="Dose"
   ...
   proc sgplot data=plot_linear noautolegend;
	  ...
	  title1 "Quantal Linear Model, with BMR of &BMR. Added Risk for the BMD and &CL. Lower Confidence Limit for the BMDL";
