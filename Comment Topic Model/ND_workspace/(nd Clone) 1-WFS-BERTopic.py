...
# MAGIC %md
# MAGIC ### BertTopic
# MAGIC * This code contains implementation of topic modeling (BERTopic) for public comments to CDC's Proposed Rule on Dog Importation. The comments can be found on **regulations.gov** (https://www.regulations.gov/document/CDC-2023-0051-0001).
# MAGIC
...
# MAGIC * [List of Supported Language Models](https://www.sbert.net/docs/pretrained_models.html)
...
# MAGIC %md
# MAGIC #### 1 - Read the CSV from the WFSP volume "datafiles"
...
# MAGIC %md
# MAGIC ##### Create DF with duplicate comments
...
# MAGIC %md
# MAGIC #### 3- Prepare Specifications for BERTopic
...
# MAGIC ##### 7a - Visual Exploration of Model(s) of Interest: Plots of Most Representative Words
# MAGIC
...
# MAGIC %md
# MAGIC ##### 7b- Hierarchical Clustering Dendogram
...
# MAGIC %md
# MAGIC Output the final dataframe to the WFSP volume "datafiles"
