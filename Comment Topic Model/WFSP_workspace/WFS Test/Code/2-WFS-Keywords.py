...
output_path = '/Volumes/edav_dev_ddnid_niosh/wfsp/datafiles/output/2024-11-22'

csv_file_path = f'{output_path}/{datafile}' # Provide the correct path to the CSV file
csv_file_path
...
datafile_no_ext = datafile.rsplit('_rev1.csv', 1)[0]  # Remove the .csv extension
datafile_no_ext
...
final_path = f"{output_path}{datafile_no_ext}_rev2.csv"
print(final_path)  # Output: /path/to/output/example_rev2.csv

# COMMAND ----------

# Save the DataFrame 'df_merged' to a CSV file
df_merged.to_csv(final_path, mode='w', index=False)