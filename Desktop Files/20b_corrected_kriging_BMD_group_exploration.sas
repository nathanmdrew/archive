...
proc export data=c1_3 outfile="Z:\MyLargeWorkspace Backup\ENM Categories\BMD Cluster Random Forest\bmd_krig_clust1_correct.csv"
			replace dbms=csv;
run;
proc export data=c2_3 outfile="Z:\MyLargeWorkspace Backup\ENM Categories\BMD Cluster Random Forest\bmd_krig_clust2_correct.csv"
			replace dbms=csv;
run;
proc export data=c3_3 outfile="Z:\MyLargeWorkspace Backup\ENM Categories\BMD Cluster Random Forest\bmd_krig_clust3_correct.csv"
			replace dbms=csv;
run;
proc export data=c4_3 outfile="Z:\MyLargeWorkspace Backup\ENM Categories\BMD Cluster Random Forest\bmd_krig_clust4_correct.csv"
			replace dbms=csv;
run;
