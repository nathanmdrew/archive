/*///////////////////////////////////////////////////////////////////////////////////////////
///  analyze gebel's data - recreate his values from the paper after omitting keratin cysts
...
data WORK.GEBEL_DATA    ;
	...
	infile "&dir.database_nokeratin_gebel.csv" delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
	informat Study $20. ;
	informat rat $8.;
	informat par_type $5. ;
...
run;
proc sort data=exposed;  by study sex;  run;
proc sort data=controls; by study sex;  run;
data pot;
...
run;
/**/
/** above won't add in Toner? ;*/
/*data pot;*/
/*	set pot*/
/*        exposed (where=(study="Ton_Muhle91"));*/
/**/
...
data save.pot_nokeratin_v2_gebel;
	set pot;
run;
