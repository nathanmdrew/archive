/*////////////////////////////////////////////////////////////////////////
///  infile "corrected" Gebel all data (all responses, include keratin cysts)
///  create ratio estimates
/*/


* corrections:
	Toner - only use full study data (Gebel combined 21 month sacrificial data)
;
...
proc summary data=pot4 nway missing;
	...
	var w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w1 (drop=_type_) mean()=avg_w_pot_geb;
run;
*
...
proc summary data=pot4 nway missing;
	class par_type;
	var w_pot_all;
	output out=gebel_ests_w2 (drop=_type_) mean()=avg_w_pot_all;
run;
*
...
proc summary data=pot4 nway missing;
	...
	var n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_n_w1 (drop=_type_) mean()=avg_n_w_pot_geb;
run;
*
...
proc summary data=pot4 nway missing;
	class par_type;
	var n_w_pot_all;
	output out=gebel_ests_n_w2 (drop=_type_) mean()=avg_n_w_pot_all;
run;
*
...
proc summary data=pot7 nway missing;
	...
	var sae_n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_sae1 (drop=_type_) mean()=avg_sae_n_w_pot_geb;
run;
*
...
proc summary data=pot7 nway missing;
	...
	var sae_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_sae2 (drop=_type_) mean()=avg_sae_w_pot_geb;
run;
*
...
proc summary data=pot7 nway missing;
	class par_type;
	var sae_n_w_pot_all;
	output out=gebel_ests_w_sae4 (drop=_type_) mean()=avg_sae_n_w_pot_all;
run;
*
...
proc summary data=pot7 nway missing;
	class par_type;
	var sae_w_pot_all;
	output out=gebel_ests_w_sae5 (drop=_type_) mean()=avg_sae_w_pot_all;
run;
*
...
proc summary data=pot7 nway missing;
	...
	var ve_n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_ve1 (drop=_type_) mean()=avg_ve_n_w_pot_geb;
run;
*
...
proc summary data=pot7 nway missing;
	...
	var ve_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_ve2 (drop=_type_) mean()=avg_ve_w_pot_geb;
run;
*
...
proc summary data=pot7 nway missing;
	class par_type;
	var ve_n_w_pot_all;
	output out=gebel_ests_w_ve4 (drop=_type_) mean()=avg_ve_n_w_pot_all;
run;
*
...
proc summary data=pot7 nway missing;
	class par_type;
	var ve_w_pot_all;
	output out=gebel_ests_w_ve5 (drop=_type_) mean()=avg_ve_w_pot_all;
run;
*
...
proc summary data=pot7 nway missing;
	...
	var mb_n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_mb1 (drop=_type_) mean()=avg_mb_n_w_pot_geb;
run;
*
	nano			0.2272376475	n=7
	micro			0.0929897294	n=7
...
proc summary data=pot7 nway missing;
	...
	var mb_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_mb2 (drop=_type_) mean()=avg_mb_w_pot_geb;
run;
*
	nano			0.1544309081	n=7
	micro			0.0381742581	n=7
...
proc summary data=pot7 nway missing;
	class par_type;
	var mb_n_w_pot_all;
	output out=gebel_ests_w_mb4 (drop=_type_) mean()=avg_mb_n_w_pot_all;
run;
*
	nano			0.1715890682	n=8
	micro			0.0355324758	n=12
...
proc summary data=pot7 nway missing;
	class par_type;
	var mb_w_pot_all;
	output out=gebel_ests_w_mb5 (drop=_type_) mean()=avg_mb_w_pot_all;
run;
*
	nano			0.1265185526	n=8
	micro			0.0234376935	n=7
...
proc summary data=pot7 nway missing;
	...
	var sab_n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_sab1 (drop=_type_) mean()=avg_sab_n_w_pot_geb;
run;
*
	nano			0.2272376475	n=7
	micro			0.0929897294	n=7
...
proc summary data=pot7 nway missing;
	...
	var sab_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_sab2 (drop=_type_) mean()=avg_sab_w_pot_geb;
run;
*
	nano			0.1544309081	n=7
	micro			0.0381742581	n=7
...
proc summary data=pot7 nway missing;
	class par_type;
	var sab_n_w_pot_all;
	output out=gebel_ests_w_sab4 (drop=_type_) mean()=avg_sab_n_w_pot_all;
run;
*
	nano			0.1715890682	n=8
	micro			0.0355324758	n=12
...
proc summary data=pot7 nway missing;
	class par_type;
	var sab_w_pot_all;
	output out=gebel_ests_w_sab5 (drop=_type_) mean()=avg_sab_w_pot_all;
run;
*
	nano			0.1265185526	n=8
	micro			0.0234376935	n=7
...
proc summary data=pot7 nway missing;
	...
	var vb_n_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_vb1 (drop=_type_) mean()=avg_vb_n_w_pot_geb;
run;
...
proc summary data=pot7 nway missing;
	...
	var vb_w_pot_geb;
	where i_gebel=1;
	output out=gebel_ests_w_vb2 (drop=_type_) mean()=avg_vb_w_pot_geb;
run;
...
proc summary data=pot7 nway missing;
	class par_type;
	var vb_n_w_pot_all;
	output out=gebel_ests_w_vb4 (drop=_type_) mean()=avg_vb_n_w_pot_all;
run;
...
proc summary data=pot7 nway missing;
	class par_type;
	var vb_w_pot_all;
	output out=gebel_ests_w_vb5 (drop=_type_) mean()=avg_vb_w_pot_all;
run;
