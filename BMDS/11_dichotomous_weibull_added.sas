...
%macro boundBMD(BMR, CL,DATAIN, DATAOUT, ESTIMATES);
   ...
   proc nlmixed data=&DATAIN maxiter=1000;
      ...
      parms _gamma = 0.006 
            ...
            _alpha=1;
      */
      parms _gamma = 0.001 to 1 by 0.005
	        _bdose = 0.001 to 10 by 0.5
			_alpha = 1.001 to 18 by 0.5;
      bounds _gamma >= 0,
             _gamma <= 1,
		     _alpha >= 1,
			 _alpha <= 18,
   ...
   *set up the initial parameters for the new likelihood;
      ...
      *fit this new “constrained” likelihood;
      proc nlmixed data= &DATAIN maxiter=1000;
         ...
         _X = (-LOG(1-(&BMR./(1 - _gamma))))**(1/_ALPHA);
   ...
   proc sgplot data=plot_weibull noautolegend;
	  ...
	  title1 "Weibull Model, with BMR of &BMR. Added Risk for the BMD and &CL. Lower Confidence Limit for the BMDL";
