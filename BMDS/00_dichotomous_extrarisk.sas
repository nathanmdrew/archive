...
%include "Z:\BMDS in SAS\01_dichotomous_weibull.sas";
...
%modelavg_BMDL_percentile(datain=dataset, num_samples=10, BMR=0.1, CL=0.95, maxiterations=100, convergence=0.00001,
			  			weibull=1, logistic=0, loglogistic=0, gamma=0, linear=0, probit=0, logprobit=1, ms2=1, ms3=0, quadratic=0,
